    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "vote",
                    models.IntegerField(validators=[forum.utils.validate_upvote_or_downvote]),
                ),
                (
                    "content_type",
                    models.ForeignKey(
            ...
            options={
                "indexes": [
                    ...
                    models.Index(fields=["user", "vote"], name="forum_userv_user_id_7ab0c3_idx"),
                    models.Index(
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["subscriber"], name="forum_subsc_subscri_34fd6c_idx"),
                    models.Index(
                        fields=[
                            "subscriber",
                            "source_object_id",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["user", "course_id"], name="forum_reads_user_id_30cd0a_idx"),
        ),
        ...
        migrations.AddIndex(
            model_name="lastreadtime",
            index=models.Index(fields=["comment_thread"], name="forum_lastr_comment_652102_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="lastreadtime",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["editor"], name="forum_edith_editor__159ea4_idx"),
        ),
        migrations.AddIndex(
            model_name="edithistory",
            index=models.Index(
        ...
        migrations.AddIndex(
            model_name="edithistory",
            index=models.Index(fields=["created_at"], name="forum_edith_created_67bba8_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="coursestat",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["context"], name="forum_comme_context_cfe3d0_idx"),
        ),
        migrations.AddIndex(
            model_name="commentthread",
            index=models.Index(fields=["author"], name="forum_comme_author__04774e_idx"),
        ),
        migrations.AddIndex(
            model_name="commentthread",
            index=models.Index(fields=["author", "course_id"], name="forum_comme_author__e6f558_idx"),
        ),
        migrations.AddIndex(
            model_name="commentthread",
            index=models.Index(
        ...
        migrations.AddIndex(
            model_name="comment",
            index=models.Index(fields=["author", "course_id"], name="forum_comme_author__257002_idx"),
        ),
        migrations.AddIndex(
            model_name="comment",
            index=models.Index(
