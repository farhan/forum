...
from importlib.metadata import version as get_version  # pylint: disable=wrong-import-position

VERSION = get_version('openedx-forum')
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'src', 'forum'),
                os.path.join(root_path, 'src', 'forum', 'migrations')])
